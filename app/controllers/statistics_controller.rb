class StatisticsController < ApplicationController
  def index
    ...
    @today     = scope.where(cup_type: "Coffee", created_at: today.all_day).sum(:amount)
    @this_week = scope.where(cup_type: "Coffee", created_at: today.all_week).sum(:amount)
    @this_month = scope.where(cup_type: "Coffee", created_at: today.all_month).sum(:amount)
